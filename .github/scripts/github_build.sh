...
timeout -k 7m -s SIGTERM ${_remaining_time:-19680}s bash -c "cd src/brave; npm run init; npm install; npm config set target_arch arm; npm run build Release" # 328 m as default $_remaining_time
